...
(1, 'João da Silva', 'joao.ger@oliveirafood.com', '123', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@oliveirafood.com', '123', utc_timestamp),
(3, 'José Souza', 'jose.aux@oliveirafood.com', '123', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@oliveirafood.com', '123', utc_timestamp),
...
values (1, 'adc559f0-832d-4405-9abc-4b506fc19017', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo,restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, '37ef2d12-2a4a-4a9c-86ae-fb845edd6c43',4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro', 'CRIADO', utc_timestamp, 79, 0, 79);
